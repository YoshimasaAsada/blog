...
export const AwsIcon = ({ width, height }: SvgIcon) => (
...
export const RubyIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <linearGradient
      id="ruby-original-a"
...
export const CentosIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <path
    ...
    <path
      ...
      fill="#262577"></path>
    <path d="M70.066 69.484h36.461v36.401H70.066zm0 0" fill="#efa724"></path>
    <path d="M70.216 22.454h36.577v36.231H70.216zm0 0" fill="#932279"></path>
    <path d="M21.1 69.484h38.084v37.753H21.1zm0 0" fill="#262577"></path>
    <path d="M21.1 20.928h38.084v37.538H21.1zm0 0" fill="#9ccd2a"></path>
    <path
...
export const NginxIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <path
...
export const PythonIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <linearGradient
...
export const PostgreIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
...
export const TsIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
...
export const NestIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <path
      fill="#df234f"
...
export const NextIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
...
export const RailsIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <path
      fill="#A62C39"
      d="M17.444 125.054s.188-29.538.188-59.564c0-58.159-4.901-62.491 21.194-62.491h72.635v83.889c0 27.615 5.162 38.433-23.859 38.433-29.021.001-70.158-.267-70.158-.267z"></path>
    <g transform="translate(-273.273 -435.955)">
      ...
      <path
        ...
        d="M350.603 449.926s4.655.932 8.688 7.757c4.034 6.826 25.444 59.886 25.444 59.886v-43.131l-19.858-32.27 5.585 6.827 10.55-8.689-13.653-.93-16.756 10.55z"></path>
    </g>
    <g transform="translate(-273.273 -435.955)">
      <radialGradient
      ...
      <path
        ...
        d="M309.335 439.686s30.719 20.479 45.613 24.513a4339.783 4339.783 0 0130.408 8.378l-35.373 86.88 15.204.621 19.86-49.026-.622-71.676-75.09.31z"></path>
      <path
        fill="#fff"
        fillOpacity=".44"
        d="M337.881 531.221l31.956 30.733-59.571-1.256s-1.861-18.927-1.241-28.856l3.723-9.929 25.133 9.308z"></path>
    </g>
    <path
      fillOpacity=".362"
      d="M94.085 125.365L65.229 95.577l-26.375-9.929-20.479-45.612L40.096 3.732l-14.584-.621-5.896 5.586-2.172 4.344-1.552 112.945 78.193-.621z"></path>
    <path
      opacity=".5"
      fill="#83222D"
      d="M111.773 77.89S82.606 87.199 65.23 95.887c-17.376 8.688-26.685 29.787-26.685 29.787s37.234-1.861 51.197-1.241c13.963.621 20.479.621 21.72-18.927 1.241-19.548.311-27.616.311-27.616z"></path>
    <g fill="#fff">
...
export const ReactIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <g fill="#61DAFB">
...
export const DockerIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const LinuxIcon = ({ width, height }: SvgIcon) => (
  <svg viewBox="0 0 128 128" width={width} height={height}>
    <radialGradient
      id="linux-original-a"
      cx="-992.915"
